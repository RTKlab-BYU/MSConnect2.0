...
from ingest.services import DEFAULT_RAW_SUFFIXES, discover_raw_paths, import_raw_path
...
class Command(BaseCommand):
    ...
    def _import_once(self, *, source, storage, run, recursive, dry_run, suffixes):
        ...
        for path in candidates:
            try:
                result = import_raw_path(path, storage_root=storage, run=run, dry_run=dry_run)
