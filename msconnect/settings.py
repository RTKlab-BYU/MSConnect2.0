...
DIRECT_UPLOAD_STAGING_ROOT = os.environ.get(
    "DIRECT_UPLOAD_STAGING_ROOT",
    str(Path(MEDIA_ROOT) / "direct-uploads"),
)
DATA_UPLOAD_MAX_MEMORY_SIZE = int(os.environ.get("DATA_UPLOAD_MAX_MEMORY_SIZE", str(32 * 1024 * 1024)))
FILE_UPLOAD_MAX_MEMORY_SIZE = int(os.environ.get("FILE_UPLOAD_MAX_MEMORY_SIZE", str(32 * 1024 * 1024)))
...
MSCONNECT_PROCESSING_RECOVERY_GRACE_SECONDS = int(
    os.environ.get("MSCONNECT_PROCESSING_RECOVERY_GRACE_SECONDS", "900")
)
MSCONNECT_IMAGE = os.environ.get("MSCONNECT_IMAGE", "msconnect:local")
MSCONNECT_RELEASE_VERSION = os.environ.get("MSCONNECT_RELEASE_VERSION", "unmanaged")
MSCONNECT_UPGRADE_HOOK = os.environ.get("MSCONNECT_UPGRADE_HOOK", "")
MSCONNECT_NOTIFICATION_EMAILS = env_csv("MSCONNECT_NOTIFICATION_EMAILS")
MSCONNECT_EMAIL_FAIL_SILENT = env_bool("MSCONNECT_EMAIL_FAIL_SILENT", not DEBUG)
